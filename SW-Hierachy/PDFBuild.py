...
from reportlab.lib.pagesizes import LETTER, inch, ELEVENSEVENTEEN, landscape
...
class FooterCanvas(canvas.Canvas):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.pages = []
        self.width, self.height = landscape(ELEVENSEVENTEEN)
...
class PDFPSReporte:
    ...
    def firstPage(self):
        ...
        psDetalle = ParagraphStyle('Resumen', fontSize=9, leading=14, justifyBreaks=1, alignment=TA_LEFT,
                                   justifyLastLine=1)
        text = """INGENIERÍA Y DESARROLLO TECNOLÓGICO<br/>
...
report = PDFPSReporte('HOLA M.PDF')